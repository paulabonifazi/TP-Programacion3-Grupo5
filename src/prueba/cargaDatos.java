...
public class cargaDatos {
	...
	public static void main(String[] args) 
	{
		...
		Agencia agencia = new Agencia();       //vuela, luego de aplicar singleton adecuadamente
		
												//ver si hay que métodos de agregar empleador y empleado pretenso a los arraylist de agencia!
